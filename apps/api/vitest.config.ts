...
// Real D1 (Miniflare) through the Workers pool: route tests seed real rows and
// exercise the endpoints' inline Drizzle queries. There is no query-helper layer
// to mock (see packages/db/README.md). GitHub and auth stay module-mocked.
