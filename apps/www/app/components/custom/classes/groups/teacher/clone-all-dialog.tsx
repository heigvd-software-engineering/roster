...
/**
 * The start-of-correction chore: every work repo of this lab, as one clone
 * command per line, copyable in a single go. The repo names already ride on
 * the roster (`repoFullName`), so this is a string transform of what the
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      {/* A clone line runs ~85 chars ("git clone https://github.com/" + org +
          slug + ".git"); 2xl fits that at text-xs before the <pre> scrolls. */}
