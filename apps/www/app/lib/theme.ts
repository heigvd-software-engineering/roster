 ...
 * Pure read/write helpers — applying the class to <html> is ThemeProvider's
 * job (contexts/theme-context.tsx); the inline script in root.tsx reads the
 * same key before first paint so a stored choice never flashes.
 */
