...
**▶ Active cursor:** _On branch `milestone-4-labs`. **F8 — Accept a lab → work repos: COMPLETE + live 🔴 PASSED** (2026-07-07); the whole F8 increment is UNCOMMITTED (commit = user-triggered batch). **Next: F9 remainder** (student standing/accept views — the class-list slice is already done) or user's call._
