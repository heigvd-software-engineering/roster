...
**▶ Active cursor:** _On branch `milestone-4-labs`. **F8 + teacher roster + ACTIVITY SLICE complete and committed 2026-07-07** (late/push indicators, token cache, batch repo creation, enriched attach menu). **Next: F9 remainder** (student standing on the hub — reuses `statusFor`) or F10 teacher dashboard._
