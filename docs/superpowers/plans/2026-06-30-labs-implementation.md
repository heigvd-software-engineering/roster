...
**▶ Active cursor:** _On branch `milestone-4-labs`. **F8 + teacher roster + activity slice + HUB SEMESTER PAGING complete 2026-07-07** (paging batch UNCOMMITTED, say-so pending). **F9 remainder DROPPED** (user-decided: no Progress/standing column — lab pages carry standing). **Next: F10 teacher dashboard** or user's call._
